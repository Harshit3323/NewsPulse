...
from scraper.db import get_db, init_db, insert_articles, insert_cluster, get_article_count, get_cluster_count
...
def main():
    ...
    logger.info("Clusters created this run: %d", len(clusters))
